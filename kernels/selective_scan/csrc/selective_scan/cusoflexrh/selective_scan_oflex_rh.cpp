...
void set_ssm_params_fwd(SSMParamsBase &params,
    ...
    params.out_dstate_stride = out.stride(2);
}
...
void set_ssm_params_bwd(SSMParamsBwd &params,
    ...
    params.dout_dstate_stride = dout.stride(2);
...
selective_scan_fwd(
    ...
    at::Tensor out = torch::empty({batch_size, dim, dstate, seqlen}, u.options().dtype(out_float? (at::ScalarType::Float): input_type));
...
selective_scan_bwd(
    ...
    CHECK_SHAPE(dout, batch_size, dim, dstate, seqlen);
    ...
    std::vector<at::Tensor> result = {du, ddelta, dA, dB.to(B.dtype()), dD, ddelta_bias};
    return result;
}
